...
namespace LoginForm.Admin
{
    public partial class usuarios : Form
    {
        ...
        public usuarios()
        {
            InitializeComponent();
            tipo = -1;
            this.ttMensaje.SetToolTip(this.btnGenerarReporte, "Generar reporte");
            this.ttMensaje.SetToolTip(this.btnAgregar, "Agregar usuario");
            this.ttMensaje.SetToolTip(this.btnEditar, "Editar usuario");
            this.ttMensaje.SetToolTip(this.btnEliminar, "Eliminar usuario");
