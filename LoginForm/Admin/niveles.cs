...
namespace LoginForm.Admin
{
    public partial class niveles : Form
    {
        ...
        {
            InitializeComponent();
            this.ttMensaje.SetToolTip(this.btnAgregar,"Agregar nivel");
        }
        ...
        public void mostrarNiveles()
        {
            try {
                ...
                for (int i = 0; i < niveles.Rows.Count; i++)
                {
                    ...
                    ttMensaje.SetToolTip(pnlNivel, nombre);
                    ...
                    btnEditar.Text = "";
                    ttMensaje.SetToolTip(btnEditar, "Editar");
                    ...
                    ttMensaje.SetToolTip(lblNombre, nombre);
                    ...
                    btnEliminar.Text = "";
                    ttMensaje.SetToolTip(btnEliminar, "Eliminar");
