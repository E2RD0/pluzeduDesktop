...
namespace LoginForm.User
{
    public partial class mensajes : Form
    {
        ...
        {
            InitializeComponent();
            this.ttMensaje.SetToolTip(this.lblIconInfo,"Información");
            this.ttMensaje.SetToolTip(this.lblBusqueda1,"Buscar...");
            this.ttMensaje.SetToolTip(this.lblIconSearch,"Buscar");
            this.ttMensaje.SetToolTip(this.lblIconArchivos, "Adjuntar");
        }
        private void mensajes_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lblBusqueda1.Font = Tipografia.fonts.fontawesome16;
                txtMensaje.Focus();
            ...
            try
            {
                ...
                for (int i = 0; i < conversaciones.Rows.Count; i++)
                {
                    ...
                    if (esGrupoConversacion)
                    {
                        ...
                        descripcionConversacion = "Descripción: " + Convert.ToString(conversaciones.Rows[i].ItemArray[3]) + ".";
                        fotoPerfil.BackgroundImageLayout = System.Windows.Forms.ImageLayout.None;
                        fotoPerfil.Image = imgGrupo.Image;
                    ...
                    pnlConversacion.Tag = idConversacion;
                    ...
                    pnlConversacion.Size = new System.Drawing.Size(263, 80);
                    ...
                    lblTiempo.Location = new System.Drawing.Point(203, 24);
                    ...
                    ttMensaje.SetToolTip(lblTiempo, fechaUltimo);
                    // 
                    // lblUltimoMensaje
                    // 
                    ...
                    ttMensaje.SetToolTip(lblUltimoMensaje, ultimoMensaje);
                    // 
                    // lblNombre
                    // 
                    lblNombre.AutoSize = true;
                    lblNombre.Font = new System.Drawing.Font("Work Sans Medium", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                    lblNombre.Location = new System.Drawing.Point(62, 22);
                    ...
                    ttMensaje.SetToolTip(lblNombre, tituloConversacion);
                    ...
                    void pnlConversacionMostrar(object sender, EventArgs e)
                    {
                        ...
                        {
                            conversacion.BackColor = System.Drawing.Color.FromArgb(230, 230, 230);
                        }
                        lblNombreInfo.Text = nombreUsuarioConversacion;
                        if (esGrupoConversacion)
                        {
                            lblInfoConversacion.Text = descripcionConversacion;
                            lblInfoConversacion.Text += "\nIntegrantes:";
                            pbxFotoInfo.Image = imgGrupo.Image;
                            DataTable integrantes = Database.funcionesCRUD.integrantesGrupo(idConversacion);
                            for (int x = 0; x < integrantes.Rows.Count; x++)
                            {
                                lblInfoConversacion.Text += "\n" + Convert.ToString(integrantes.Rows[x].ItemArray[0]) + " " + Convert.ToString(integrantes.Rows[x].ItemArray[1]);
                            }
                        }
                        else
                        {
                            ...
                            for (int j = 0; j < nombreConversacion.Rows.Count; j++)
                            {
                                ...
                                if (idUsuarioConversacion != idUsuarioActual)
                                {
                                    ...
                                    result.ContinueWith(task =>
                                    {
                                        pbxFotoInfo.Image = task.Result;
                                    });
                                    lblInfoConversacion.Text = "Niveles: ";
        ...
        public void mostrarMensajes(int idConversacion)
        {
            try
            {
            ...
            try
            {
                ...
                if (idConInd == 0)
                {
                    ...
                    if (CCI > 0)
                    {
                        ...
                        foreach (Control conversacion in flpConversaciones.Controls)
                        {
                            if (conversacion is Panel panel)
                                if ((int)panel.Tag == idConversacionActual)
                                    conversacion.BackColor = Color.FromArgb(((int)(((byte)(51)))), ((int)(((byte)(204)))), ((int)(((byte)(255)))));
                                else
                                    conversacion.BackColor = System.Drawing.Color.FromArgb(230, 230, 230);
                        }
                        //pnlConversacion.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(51)))), ((int)(((byte)(204)))), ((int)(((byte)(255)))));
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(busquedatxt.Trim()))
                {
                    ...
                    for (int o = 0; o < niveles.Rows.Count; o++)
                    {
                        ...
                        flpBusqueda.Controls.Add(lblNivel);
                        ...
                        {
                            {
                                if (busqueda.Rows.Count > 0)
                                {
                                    ...
                                    lblName.TabIndex = 0;
                                    lblName.Text = nombre;
                                    ttMensaje.SetToolTip(lblName, "Nombre");
                                    ...
                                    if (Convert.ToString(busqueda.Rows[i].ItemArray[3]) == "Maestro")
                                    {
                                        ...
                                        ttMensaje.SetToolTip(lblNameIdentificador, "Maestro");
                                    ...
                                    flpBusqueda.Controls.Add(pnlName);
                                }
                                else { }
                            }
                        }
